...
<head><meta charset="UTF-8"><title>Page introuvable — ImmoGest</title>
...
<div style="min-height:100vh;background:var(--navy);display:flex;align-items:center;justify-content:center;flex-direction:column;text-align:center;padding:20px">
  ...
  <h1 style="font-family:'Playfair Display',serif;font-size:80px;color:var(--gold);margin:0;line-height:1">404</h1>
  <p style="color:rgba(255,255,255,0.7);font-size:18px;margin:16px 0 32px">Cette page est introuvable</p>
