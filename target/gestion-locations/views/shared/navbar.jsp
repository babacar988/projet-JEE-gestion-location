...
<%
  ...
  if (u == null) { return; } // AuthFilter redirige déjà, on sort juste silencieusement
...
<div class="main-content" id="panel">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="#" class="dropdown-item text-danger"
                 onclick="openLogoutModal(); return false;">
                <i class="ni ni-user-run"></i><span>Déconnexion</span>
              </a>
            </div>
          </li>
        </ul>
  ...
  <%-- main-content reste OUVERT — chaque JSP le ferme avec </div> --%>
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center py-4">
        ...
        <p class="text-sm text-muted mb-0">Voulez-vous vraiment quitter votre session ?</p>
