...
<!DOCTYPE html><html>
<head><title>Mon profil — ImmoGest</title>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card card-profile shadow">
                ...
                <span class="avatar avatar-xl rounded-circle bg-gradient-primary text-white"
                      style="font-size:2rem;font-weight:800;display:flex;align-items:center;justify-content:center;width:90px;height:90px">
                ...
                <div class="card-body pt-0 pt-md-4">
                    <div class="text-center mt-md-5">
                        <h4>${sessionScope.utilisateur.prenom} ${sessionScope.utilisateur.nom}</h4>
                        ...
                        <div class="mt-3">
                            <c:choose>
                                <c:when test="${userRole=='admin'}"> <span class="badge badge-primary badge-pill">Administrateur</span></c:when>
                                <c:when test="${userRole=='proprietaire'}"> <span
                                        class="badge badge-warning badge-pill">Propriétaire</span></c:when>
                                <c:otherwise> <span
                                        class="badge badge-info    badge-pill">Locataire</span></c:otherwise>
                            </c:choose>
                        </div>
                        <hr>
            ...
            <div class="card shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8"><h3 class="mb-0">Modifier mes informations</h3></div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="${pageContext.request.contextPath}/profil">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label">Nouveau mot de passe
